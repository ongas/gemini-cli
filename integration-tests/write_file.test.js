...
describe('write_file', () => {
    it('should be able to write a file', async () => {
        ...
        expect(foundToolCall, 'Expected to find a write_file tool call').toBeTruthy(createToolCallErrorMessage('write_file', allTools.map((t) => t.toolRequest.name), result));
