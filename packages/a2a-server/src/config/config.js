...
import { AuthType, Config, FileDiscoveryService, ApprovalMode, loadServerHierarchicalMemory, GEMINI_CONFIG_DIR, DEFAULT_GEMINI_EMBEDDING_MODEL, DEFAULT_GEMINI_MODEL, } from '@google/gemini-cli-core';
...
export async function loadConfig(settings, extensions, taskId) {
    ...
    const { memoryContent, fileCount } = await loadServerHierarchicalMemory(workspaceDir, [workspaceDir], false, fileService, extensionContextFilePaths, settings.folderTrust === true);
