...
export declare function getWorkspaceExtensions(
  workspaceDir: string,
): Extension[];
...
export declare function performWorkspaceExtensionMigration(
...
export declare function loadExtension(
  context: LoadExtensionContext,
): Extension | null;
export declare function loadExtensionByName(
  name: string,
  workspaceDir?: string,
): Extension | null;
 ...
 */
export declare function annotateActiveExtensions(
  extensions: Extension[],
  workspaceDir: string,
...
export declare function installExtension(
...
export declare function loadExtensionConfig(
  context: LoadExtensionContext,
): ExtensionConfig;
...
export declare function toOutputString(
  extension: Extension,
  workspaceDir: string,
): string;
export declare function disableExtension(
  name: string,
  scope: SettingScope,
  cwd?: string,
): void;
export declare function enableExtension(
  name: string,
  scope: SettingScope,
  cwd?: string,
): void;
