...
describe('ExtensionEnablementManager', () => {
    ...
    describe('validateExtensionOverrides', () => {
        ...
        it('should log an error for each invalid extension name in enabledExtensionNamesOverride', () => {
            ...
            expect(consoleErrorSpy).toHaveBeenCalledWith('Extension not found: ext-invalid');
            expect(consoleErrorSpy).toHaveBeenCalledWith('Extension not found: ext-another-invalid');
        });
