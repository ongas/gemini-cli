...
declare const SETTINGS_SCHEMA: {
    ...
    readonly model: {
        ...
        readonly properties: {
            ...
            readonly ollama: {
                ...
                readonly requiresRestart: false;
                readonly default: {};
                readonly description: "Settings for local Ollama models.";
                readonly showInDialog: false;
                readonly properties: {
                    readonly enabled: {
                        readonly type: "boolean";
                        readonly label: "Enable Ollama";
                        readonly category: "Model";
                        readonly requiresRestart: false;
                        readonly default: false;
                        readonly description: "Enable Ollama local model support.";
                        readonly showInDialog: true;
                    };
                    readonly baseUrl: {
                        readonly type: "string";
                        ...
                        readonly description: "The base URL for Ollama API.";
                        readonly showInDialog: true;
                    };
                    readonly defaultModel: {
                        readonly type: "string";
                        readonly label: "Default Ollama Model";
                        readonly category: "Model";
                        readonly requiresRestart: false;
                        readonly default: "llama3";
                        readonly description: "The default Ollama model to use.";
                        readonly showInDialog: true;
                    };
                };
            };
    ...
    readonly useWriteTodos: {
        ...
        readonly requiresRestart: false;
        readonly default: true;
        readonly description: "Enable the write_todos_list tool for automatic task management.";
        readonly showInDialog: false;
    };
    readonly security: {
        readonly type: "object";
    ...
    readonly experimental: {
        ...
        readonly properties: {
            ...
            readonly enableSubagents: {
                readonly type: "boolean";
                readonly label: "Enable Subagents";
                readonly category: "Experimental";
                readonly requiresRestart: true;
                readonly default: false;
                readonly description: "Enable subagents for multi-agent workflows and specialized tasks.";
                readonly showInDialog: false;
            };
        };
    };
