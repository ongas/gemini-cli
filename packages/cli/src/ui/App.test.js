...
describe('App', () => {
    ...
    it('should render main content and composer when not quitting', () => {
        const { lastFrame } = render(_jsx(UIStateContext.Provider, { value: mockUIState, children: _jsx(App, {}) }));
    ...
    it('should render quitting display when quittingMessages is set', () => {
        ...
        const { lastFrame } = render(_jsx(UIStateContext.Provider, { value: quittingUIState, children: _jsx(App, {}) }));
    ...
    it('should render dialog manager when dialogs are visible', () => {
        ...
        const { lastFrame } = render(_jsx(UIStateContext.Provider, { value: dialogUIState, children: _jsx(App, {}) }));
        expect(lastFrame()).toContain('MainContent');
        expect(lastFrame()).toContain('Notifications');
    ...
    it('should show Ctrl+C exit prompt when dialogs are visible and ctrlCPressedOnce is true', () => {
        ...
        const { lastFrame } = render(_jsx(UIStateContext.Provider, { value: ctrlCUIState, children: _jsx(App, {}) }));
    ...
    it('should show Ctrl+D exit prompt when dialogs are visible and ctrlDPressedOnce is true', () => {
        ...
        const { lastFrame } = render(_jsx(UIStateContext.Provider, { value: ctrlDUIState, children: _jsx(App, {}) }));
