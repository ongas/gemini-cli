...
import { DEFAULT_GEMINI_FLASH_MODEL, IdeClient, ideContextStore, getErrorMessage, getAllGeminiMdFilenames, AuthType, clearCachedCredentialFile, recordExitFail, ShellExecutionService, debugLogger, coreEvents, CoreEvent, } from '@google/gemini-cli-core';
...
export const AppContainer = (props) => {
    ...
    const [extensionManager] = useState(new ExtensionManager({
        ...
        requestConsent: (description) => requestConsentInteractive(description, addConfirmUpdateExtensionRequest),
    ...
    const { extensionsUpdateState, extensionsUpdateStateInternal, dispatchExtensionStateUpdate, } = useExtensionUpdates(extensions, extensionManager, historyManager.addItem);
