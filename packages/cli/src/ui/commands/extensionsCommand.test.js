 ...
 */
import { updateAllUpdatableExtensions, updateExtension, } from '../../config/extensions/update.js';
...
const mockUpdateExtension = updateExtension;
const mockUpdateAllUpdatableExtensions = updateAllUpdatableExtensions;
...
describe('extensionsCommand', () => {
    ...
    describe('update', () => {
        ...
        it('should call setPendingItem and addItem in a finally block on failure', async () => {
            mockUpdateAllUpdatableExtensions.mockRejectedValue(new Error('Something went wrong'));
            await updateAction(mockContext, '--all');
            expect(mockContext.ui.setPendingItem).toHaveBeenCalledWith({
                type: MessageType.EXTENSIONS_LIST,
            });
        ...
        it('should update a single extension by name', async () => {
            ...
            expect(mockUpdateExtension).toHaveBeenCalledWith(extension, '/test/dir', expect.any(Function), ExtensionUpdateState.UPDATE_AVAILABLE, expect.any(Function));
        });
        ...
        it('should update multiple extensions by name', async () => {
            ...
            mockContext.ui.extensionsUpdateState.set(extensionOne.name, ExtensionUpdateState.UPDATE_AVAILABLE);
            mockContext.ui.extensionsUpdateState.set(extensionTwo.name, ExtensionUpdateState.UPDATE_AVAILABLE);
            mockUpdateExtension
