...
const StatRow = ({ title, values, isSubtle = false, isSection = false }) =>
  _jsxs(Box, {
    children: [
      _jsx(Box, {
...
export const ModelStatsDisplay = () => {
  ...
  return _jsxs(Box, {
    ...
    children: [
      ...
      _jsx(StatRow, { title: 'API', values: [], isSection: true }),
      _jsx(StatRow, {
        title: 'Requests',
      ...
      _jsx(Box, { height: 1 }),
      _jsx(StatRow, { title: 'Tokens', values: [], isSection: true }),
      _jsx(StatRow, {
        title: 'Total',
        values: getModelValues((m) =>
          _jsx(Text, {
