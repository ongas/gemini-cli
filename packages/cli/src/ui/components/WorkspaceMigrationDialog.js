      ...
      children:
        failedExtensions.length > 0
          ? _jsxs(_Fragment, {
              children: [
                _jsx(Text, {
                  ...
                  children:
                    "The following extensions failed to migrate. Please try installing them manually. To see other changes, Gemini CLI must be restarted. Press 'q' to quit.",
                }),
                _jsx(Box, {
                  flexDirection: 'column',
                  marginTop: 1,
                  marginLeft: 2,
                  children: failedExtensions.map((failed) =>
                    _jsxs(Text, { children: ['- ', failed] }, failed),
                  ),
                }),
              ],
            })
          : _jsx(Text, {
              color: theme.text.primary,
              children:
                "Migration complete. To see changes, Gemini CLI must be restarted. Press 'q' to quit.",
            }),
    });
  }
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Text, {
        bold: true,
        color: theme.text.primary,
        children: ['Workspace-level extensions are deprecated', '\n'],
      }),
      _jsx(Text, {
        color: theme.text.primary,
        children: 'Would you like to install them at the user level?',
      }),
      _jsx(Text, {
        color: theme.text.primary,
        children:
      ...
      _jsx(Box, {
        ...
        marginTop: 1,
        marginLeft: 2,
        children: workspaceExtensions.map((extension) =>
          _jsxs(
            Text,
            { children: ['- ', extension.config.name] },
