...
describe('<MaxSizedBox />', () => {
  ...
  it('hides lines when content exceeds maxHeight', () => {
    const { lastFrame } = render(
      _jsx(OverflowProvider, {
        children: _jsxs(MaxSizedBox, {
          maxWidth: 80,
          maxHeight: 2,
          children: [
            _jsx(Box, { children: _jsx(Text, { children: 'Line 1' }) }),
            _jsx(Box, { children: _jsx(Text, { children: 'Line 2' }) }),
            _jsx(Box, { children: _jsx(Text, { children: 'Line 3' }) }),
          ],
        }),
      }),
    );
    ...
    const { lastFrame } = render(
      _jsx(OverflowProvider, {
        children: _jsxs(MaxSizedBox, {
          ...
          maxHeight: 20,
          children: [
            _jsx(Box, { children: _jsx(Text, { children: 'Example' }) }),
            _jsxs(Box, {
              children: [
                _jsx(Text, { children: 'No Wrap: ' }),
                _jsx(Text, { wrap: 'wrap', children: multilineText }),
              ],
            }),
            _jsxs(Box, {
              children: [
                _jsx(Text, { children: 'Longer No Wrap: ' }),
                _jsx(Text, {
                  wrap: 'wrap',
                  children: 'This part will wrap around.',
                }),
              ],
            }),
          ],
    ...
    const { lastFrame } = render(
      _jsx(OverflowProvider, {
        children: _jsx(MaxSizedBox, {
          ...
          children: _jsxs(Box, {
            children: [
              _jsx(Text, { children: 'No' }),
              _jsx(Text, { wrap: 'wrap', children: 'wrap' }),
            ],
          }),
        }),
      }),
      ...
      _jsx(OverflowProvider, {
        children: _jsxs(MaxSizedBox, {
          ...
          children: [
            _jsxs(Box, {
              children: [
                _jsx(Text, { children: 'AAA' }),
                _jsx(Text, { wrap: 'wrap', children: 'first' }),
              ],
            }),
            _jsxs(Box, {
              children: [
                _jsx(Text, { children: 'BBB' }),
                _jsx(Text, { wrap: 'wrap', children: 'second' }),
              ],
            }),
            _jsxs(Box, {
              children: [
                _jsx(Text, { children: 'CCC' }),
                _jsx(Text, { wrap: 'wrap', children: 'third' }),
              ],
            }),
          ],
        }),
        ...
        children: _jsxs(MaxSizedBox, {
          ...
          children: [
            _jsxs(_Fragment, {
              children: [
                _jsx(Box, {
                  children: _jsx(Text, { children: 'Line 1 from Fragment' }),
                }),
                _jsx(Box, {
                  children: _jsx(Text, { children: 'Line 2 from Fragment' }),
                }),
              ],
            }),
            _jsx(Box, {
              children: _jsx(Text, { children: 'Line 3 direct child' }),
            }),
          ],
        }),
      }),
