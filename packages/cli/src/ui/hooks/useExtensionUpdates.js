...
export const useExtensionUpdates = (extensions, extensionManager, addItem) => {
    ...
    useEffect(() => {
        ...
        for (const extension of extensions) {
            ...
            if (!shouldUpdate) {
                ...
                const updatePromise = updateExtension(extension, extensionManager, currentState.status, dispatchExtensionStateUpdate);
