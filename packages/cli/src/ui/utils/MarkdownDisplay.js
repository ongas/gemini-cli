        ...
        addContentBlock(
          _jsx(
            Box,
            {
              children: _jsx(Text, {
                wrap: 'wrap',
                children: _jsx(RenderInline, { text: line }),
              }),
            },
            key,
          ),
      ...
      switch (level) {
        case 1:
          headerNode = _jsx(Text, {
            ...
            children: _jsx(RenderInline, { text: headerText }),
          });
          break;
        case 2:
          headerNode = _jsx(Text, {
...
const RenderListItemInternal = ({
  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsx(Box, {
        width: prefixWidth,
        children: _jsx(Text, { color: theme.text.primary, children: prefix }),
      }),
      _jsx(Box, {
        ...
        children: _jsx(Text, {
          wrap: 'wrap',
          color: theme.text.primary,
          children: _jsx(RenderInline, { text: itemText }),
        }),
      }),
    ],
  });
