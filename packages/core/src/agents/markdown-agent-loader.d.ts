...
export declare class MarkdownAgentLoader {
     ...
     */
    static loadFromDirectory(agentsDir: string, debugMode?: boolean): Promise<AgentDefinition[]>;
    /**
     ...
     */
    static loadFromFile(filePath: string, debugMode?: boolean): Promise<AgentDefinition | null>;
    /**
