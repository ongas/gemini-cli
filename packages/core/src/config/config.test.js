...
describe('Server Config (config.ts)', () => {
    ...
    describe('createToolRegistry', () => {
        ...
        it('should register subagents as tools when enableSubagents is true', async () => {
            ...
            AgentRegistryMock.prototype.getAllDefinitions.mockReturnValue(mockAgentDefinitions);
            ...
            expect(SubagentToolWrapperMock).toHaveBeenCalledWith(mockAgentDefinitions[0], config, undefined);
            expect(SubagentToolWrapperMock).toHaveBeenCalledWith(mockAgentDefinitions[1], config, undefined);
