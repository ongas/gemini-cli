...
export declare const EVENT_SMART_EDIT_STRATEGY =
  'gemini_cli.smart_edit.strategy';
export declare const EVENT_MODEL_ROUTING = 'gemini_cli.model_routing';
export declare const EVENT_SMART_EDIT_CORRECTION =
  'gemini_cli.smart_edit.correction';
export declare const EVENT_STARTUP_PERFORMANCE =
  'gemini_cli.startup.performance';
export declare const EVENT_MEMORY_USAGE = 'gemini_cli.memory.usage';
