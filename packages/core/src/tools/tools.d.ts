...
export declare abstract class BaseToolInvocation<TParams extends object, TResult extends ToolResult> implements ToolInvocation<TParams, TResult> {
    ...
    constructor(params: TParams, messageBus?: MessageBus | undefined, _toolName?: string | undefined, _toolDisplayName?: string | undefined);
...
export declare abstract class DeclarativeTool<TParams extends object, TResult extends ToolResult> implements ToolBuilder<TParams, TResult> {
    ...
    constructor(name: string, displayName: string, description: string, kind: Kind, parameterSchema: unknown, isOutputMarkdown?: boolean, canUpdateOutput?: boolean, messageBus?: MessageBus | undefined, extensionId?: string | undefined);
