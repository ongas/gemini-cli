...
8. **IMPORTANT: If you created a todo list, when all tasks are completed or cancelled, you MUST clear the todo list by calling this tool with an empty array (todos: []). This signals that the work is done and prevents stale todos from appearing in future requests. Do NOT clear the todo list if you never created one in the first place.**
