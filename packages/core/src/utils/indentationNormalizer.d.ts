...
export declare function detectIndentationStyle(
  content: string,
): IndentationStyle;
/**
 ...
 */
export declare function validatePythonSyntax(
  code: string,
  timeout?: number,
): Promise<string | null>;
/**
 ...
 */
export declare function tryFixPythonIndentation(
  code: string,
  fileIndentStyle: IndentationStyle,
): Promise<string>;
