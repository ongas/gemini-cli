 ...
 */
export async function loadServerHierarchicalMemory(currentWorkingDirectory, includeDirectoriesToReadGemini, debugMode, fileService, extensions, folderTrust, importFormat = 'tree', fileFilteringOptions, maxDirs = 200) {
    if (debugMode)
