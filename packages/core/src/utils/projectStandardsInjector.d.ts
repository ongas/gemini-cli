 ...
 */
export declare function findProjectStandardsDirectory(
  startDir: string,
): Promise<string | null>;
/**
 * Load project standards files
 */
export declare function loadProjectStandards(
  projectStandardsDir: string,
): Promise<ProjectStandards>;
/**
 * Build context string from relevant standards based on task detection
 */
export declare function buildContextFromStandards(
 ...
 */
export declare function injectProjectStandards(
  userPrompt: string,
 ...
 */
export declare function getProjectStandardsSystemMessage(
  userPrompt: string,
  workingDirectory: string,
): Promise<string | null>;
export {};
