 ...
 */
import { IdeDiffAcceptedNotificationSchema, IdeDiffClosedNotificationSchema, } from '@google/gemini-cli-core/src/ide/types.js';
    ...
    async closeDiff(filePath, suppressNotification = false) {
        ...
        if (uriToClose) {
            ...
            if (!suppressNotification) {
                this.onDidChangeEmitter.fire(IdeDiffClosedNotificationSchema.parse({
                    jsonrpc: '2.0',
